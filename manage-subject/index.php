...
<head>
    ...
    <script>
      ...
      function show_data_tbl()
      {
        ...
        setTimeout(function(){
        $('#data_auto_load').load('data-table-load.php?course='+course+'&depart='+depart+'&batch_id='+batch_id+'&sem_id='+sem_id).fadeIn("fast");
      }, 1000);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-search fa-fw"></i>Search Subjects</h1>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <i class="fa fa-eye fa-fw"></i>Search Subjects
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <form class="" role="form" id="subject_search" name="subject_search">
                                                <!--1st Part-->
                                                <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group" style="text-align: right;">
                                                        ...
                                                        <button type="button" class="btn btn-primary" onclick="show_data_tbl();" name="subject_search_submit" id="subject_search_submit">Search</button>
                                                    </div>
                                                </div>
                                                <!--Full Part Button col 12-->
                                            </form>
