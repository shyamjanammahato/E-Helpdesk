...
$notification_sl=base64_decode(base64_decode($_REQUEST['notification_sl']));

$query_update=mysqli_query($conn,"UPDATE user_notification set view_stat_n='1' where sl='$notification_sl' ");
?>
<html><head>
    <meta charset="utf-8">
