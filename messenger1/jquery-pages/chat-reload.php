...
else
{
  ...
  else
  {
    ...
    ?><div class="chat-discussion"><?php
      ...
      if ($sender_id == $id1)
      {
        $get_chat_user_s=mysqli_query($conn,"SELECT * FROM login_tbl WHERE mail_id='$sender_id'");
        ...
        <div class="right clearfix">
          <img class="img-circle" src="../images/user_image/<?php echo $user_picture_s;?>.jpg" alt="<?php echo $user_name_s;?>" style="width: 50px;height: 50px;">
            <a class="#" href="#"><?php echo $user_name_s;?></a>
            <small class=" text-muted">
              <i class="fa fa-clock-o fa-fw"></i><?php echo $time_diff;?></span>
            </small>
            <p>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $messege;?>
            </p>
      ...
      {
        $get_chat_user_r=mysqli_query($conn,"SELECT * FROM login_tbl WHERE mail_id='$r_userid'");
        ...
        <div class="left clearfix">
          <img class="img-circle" src="../images/user_image/<?php echo $user_picture_r;?>.jpg" alt="<?php echo $user_name_r;?>" style="width: 50px;height: 50px;">
            <a class="#" href="#"><?php echo $user_name_r;?></a>
            <small class=" text-muted">
              <i class="fa fa-clock-o fa-fw"></i><?php echo $time_diff;?>  </span>
            </small>
            <p>
