$(function() {
 ...
 $('#edit_mod_submit').click(function(event) {
    ...
    else
    {
      $.ajax({
      type: 'POST',
      url: 'add-moderator-code/edit-moderator-code.php',
      data: ({ sl: sl , mode_name: mode_name , mode_email: mode_email , mode_gender: mode_gender , mode_mob: mode_mob }),
      success: function(response) {
      if(response == "2")
      {
        setTimeout(function(){
          $("#error_id").html("<div class='alert alert-danger alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Error!</strong> Moderator Already Exists.</div>").fadeIn("fast");
        }, 100);
      }
      else if(response == "1")
      {
        setTimeout(function(){
          $("#error_id").html("<div class='alert alert-success alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Success!</strong> Moderator Updated Successfully.</div>").fadeIn("fast");
        }, 100);
