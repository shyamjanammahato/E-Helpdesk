...
<head>
    ...
    <script>
      ...
      function show_data_tbl()
      {
        ...
        setTimeout(function(){
        $('#data_auto_load').load('data-table-load.php?course='+course+'&depart='+depart+'&batch='+batch+'&sem='+sem).fadeIn("fast");
      }, 1000);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-exchange fa-fw"></i>Demote Students</h1>
                        <div class="row">
                            <div class="col-lg-12">
