    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-laptop fa-fw"></i>Notifications</h1>
                        <div class="col-lg-5">
                            <div class="panel panel-default">
                                ...
                                if($ro=mysqli_fetch_array($qu))
                                {
                                    ...
                                    $get_alert=mysqli_query($conn,"SELECT * FROM user_notification where to_u_id='$id1' and notify_id='$post_sl' ");
