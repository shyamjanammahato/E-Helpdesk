            ...
            <div class="panel-body">
                <table id="dataTables-example" width="100%" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                          $scl=0;
                          $get_query=mysqli_query($conn,"SELECT * from user_details where course_id='$course' and depart_id='$depart' and sem_id='$sem' and batch='$batch' and user_type='3' ");
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li><a href="javascript:void(0);" onclick="delete_fn('<?php echo base64_encode($unique_id);?>')">Delete</a></li>
                                      <?php
                                        if($stat=='1')
                                          {
                                        ?>
