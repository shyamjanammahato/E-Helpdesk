    ...
    <script>
      function show_depart(sl)
      {
        ...
        setTimeout(function(){
          ...
          $('#sem_load').load('load-sem.php?sl='+sl).fadeIn("fast");
        }, 1000);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-search fa-fw"></i>Search Students</h1>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <i class="fa fa-eye fa-fw"></i>Search Students
                                    </div>
                                            ...
                                            <form class="" role="form" id="stud_search" name="stud_search">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group" style="text-align: right;">
                                                        ...
                                                        <button type="button" class="btn btn-primary" onclick="show_data_tbl();" name="stud_search_submit" id="stud_search_submit">Search</button>
                                                    </div>
                                                </div>
                                                <!--Full Part Button col 12-->
                                            </form>
