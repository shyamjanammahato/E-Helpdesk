...
<head>
    ...
    <script>
      function show_depart(sl)
      {
        ...
        $('#auto_load1').html("<strong><label>Loading...</label><br><input type='input' class='form-control' placeholder='loading Batches' disabled></strong>").fadeIn("fast");
        $('#sem_load').html("<strong><label>Loading...</label><br><input type='input' class='form-control' placeholder='loading Semesters' disabled></strong>").fadeIn("fast");
        setTimeout(function(){
      ...
      function show_data_tbl()
      {
        ...
        setTimeout(function(){
        $('#data_auto_load').load('data-table-load.php?course='+course+'&depart='+depart+'&batch='+batch+'&category='+category).fadeIn("fast");
      }, 1000);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-info-circle fa-fw"></i>Students Status</h1>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <form class="" role="form" id="stud_search_frm" name="stud_search_frm" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                                <!--1st Part-->
                                                <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group" style="text-align: right;">
                                                        ...
                                                        <button type="button" class="btn btn-primary" onclick="show_data_tbl();" name="stud_search" id="stud_search">Search</button>
                                                    </div>
                                                </div>
                                                <!--Full Part Button col 12-->
                                            </form>
